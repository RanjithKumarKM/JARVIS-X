...
print("=" * 70)
print("        JARVIS-X REAL-WORLD GENERALIZATION TEST")
print("=" * 70)
...
# IMPORTANT:
# Use the vocabulary learned during training.
...
def predict(text):
    ...
    # Same maximum length used during training
